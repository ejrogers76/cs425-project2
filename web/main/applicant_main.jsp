...
<html>
    ...
    <body>
        ...
        <a href="<%= request.getContextPath() %>/main/applicant_skills.jsp" target="_self">Skills</a> <br>
        <a href="<%= request.getContextPath() %>/main/applicant_jobs.jsp" target="_self">Jobs</a> <br>
        <a href="<%= request.getContextPath() %>/main/applicant_report.jsp" target="_self">Report</a> <br>
